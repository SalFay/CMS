...
namespace SalFay\LaravelHooks;
	 ...
	 *
	 * This class is heavily based on the WordPress plugin API and most (if not
	 * all) of the code comes from there.
	 *
	 *
	 * @version 0.1.3
	 * @copyright 2012 - 2014
...
class LaravelHooks {
	 ...
	 * @param mixed $value The value on which the filters hooked to
	 *     <tt>$tag</tt> are applied on.
	...
	/**
	 * apply_filters_ref_array Execute functions hooked on a specific filter
	 ...
	 * @since 0.1
	 *
	 * @param string $tag The name of the action to which the $function_to_add
	 *     is hooked.
	 ...
	 *     functions associated with a particular action are executed (default:
	 *     10). Lower numbers correspond with earlier execution, and functions
	 ...
	 * @since 0.1
	 *
	 * @param string $tag The name of the filter to hook the $function_to_add
	 *     to.
	 * @param callback $function_to_add The name of the function to be called
	...
	public function add_filter ( $tag, $function_to_add, $priority = 10, $accepted_args = 1 ) {
		...
		$this->filters[$tag][$priority][$idx] = array( 'function'      => $function_to_add,
	 ...
	 *     If === false and $function is an object reference, we return the
	 *     unique id only if it already has one, false otherwise.
	 *
	 * @return string|bool Unique ID for usage as array key or false if
	 *     $priority === false and $function is an object reference, and it
	 *     does not already have a unique id.
	 */
	 ...
	 *
	 * @return mixed If $function_to_check is omitted, returns boolean for
	 *     whether the hook has anything registered. When checking a specific
	 *     function, the priority of that hook is returned, or false if the
	 *     function is not attached. When using the $function_to_check
	 *     argument, this function may return a non-boolean value that
	 *     evaluates to false
	 ...
	 * @since 0.1
	 *
	 * @param string $tag The action hook to which the function to be removed
	 *     is hooked.
	 * @param callback $function_to_remove The name of the function which
	 *     should be removed.
	 ...
	 * @since 0.1
	 *
	 * @param string $tag The filter hook to which the function to be removed
	 *     is hooked.
	 * @param callback $function_to_remove The name of the function which
	 *     should be removed.
	 * @param int $priority optional. The priority of the function (default:
	...
	/**
	 * do_action_ref_array Execute functions hooked on a specific action hook,
	 ...
	 *
	 * The function current_filter() only returns the most recent filter or
	 * action being executed. did_action() returns true once the action is
	 * initially processed. This function allows detection for any filter
